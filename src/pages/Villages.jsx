...
export default class Villages extends Component {
    render() {
        return (
            ...
            <Fragment>
                <Nav />
                <Banners imageid="villagess" title="Football Villages" info="When players deposit $coach tokens, they will receive $coach tokens in proportion to their deposits. The $coach token will be the governance token of Mutant Football Manager. The banker distributes fees gotten in game to depositors which includes 20% of collected fees from the DEX, 20% of proceeds from in game transactions. 
